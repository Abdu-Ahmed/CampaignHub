    ...
    */
    ...
    'route' => [
        ...
        'middleware' => [
                       ...
                       // 2) Boot your Sanctum guard so @guard / auth:sanctum directives work
                       Nuwave\Lighthouse\Http\Middleware\AttemptAuthentication::class,
            
                       // 3) (Optional) If you want to require auth on **all** operations
                       //     you could add Laravel’s `auth:sanctum` middleware here too:
